      ...
      >
        ...
        <motion.div
          className="absolute w-full h-full backface-hidden rounded overflow-hidden 
                   ...
                   hover:shadow-matrix-glow transition-all duration-300 flex items-center justify-center"
        ...
        >
          ...
          <img 
            src={image} 
            alt={title}
            className="w-full h-full max-h-full object-contain p-2 sm:p-3 md:p-4"
          />
        </motion.div>
